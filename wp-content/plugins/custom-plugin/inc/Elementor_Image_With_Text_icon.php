<?php
	...
	class Elementor_Image_With_Text_icon extends \Elementor\Widget_Base {

		public function get_name() {
					return 'image-with-text-and-icon';
				}

		public function get_title() {
					return __( 'Image With Text And Icon', 'plugin-name' );
				}
		...
		protected function render() {
					...
					if ( $settings['list'] ) {
						foreach (  $settings['list'] as $item ) {
							...
							echo '<div>' . $item['list_content'] . '</div><span class="'.$item['icon'].'"></span></div>';
						}
					}
					echo '</div>';
		}
